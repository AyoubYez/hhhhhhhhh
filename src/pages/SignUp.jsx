...
function SignUp() {
  ...
  return (
    <div className="sign">
      <div className="left">
        <img src="../assets/nest_marketing.svg" alt="Nest Marketing" />
      </div>
      <div className="right">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <i>
              <img src="./assets/email.png" alt="Address Icon" />
            </i>
            <input
              type="text"
              placeholder="Address"
          ...
          <div>
            <i>
              <img src="./assets/email.png" alt="Postal Code Icon" />
            </i>
            <input
              type="text"
          ...
          <div>
            <i>
              <img src="./assets/email.png" alt="City Icon" />
            </i>
            <input
              type="text"
              placeholder="City"
          ...
          <div>
            <i>
              <img src="./assets/password.png" alt="Confirm Password Icon" />
            </i>
            <input
              type="password"
